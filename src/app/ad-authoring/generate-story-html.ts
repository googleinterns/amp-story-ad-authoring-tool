...
export function generateStoryAmpHtml(ampHtml: generateAmpHtmlParams) {
  ...
  const storyAmpHtml = `<!doctype html>
    ...
    <head>
       ...
       <link rel="canonical" href="https://server.makestories.io/preview/-MEVJBwpSuNcNIaVsBAl">
    ...
    <body>
       ...
       <amp-story standalone poster-portrait-src="https://ss.makestories.io/get?story=-MEVJBwpSuNcNIaVsBAl&version=1597200933372&width=696&height=928" publisher-logo-src="https://app.makestories.io/images/favicon.png" publisher="MakeStories" title="New Story"    >
          ...
          <amp-story-bookend src="https://server.makestories.io/preview/-MEVJBwpSuNcNIaVsBAl/bookend.json" layout="nodisplay"></amp-story-bookend>    
       </amp-story>
    </body>
    </html>`;
  return storyAmpHtml;
